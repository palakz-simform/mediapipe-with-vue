  ...
  <div class="container">
      <div id="facial-insights-wrapper-vto" class="video-container position-relative">
        <div class="output-container">
            <canvas class="output_canvas_vto"></canvas>
            <div id="threejs-container-vto"></div>
            <div id="facial-insights-placeholder-vto" style="width:100%;height:100%;color:#dedede;background-color:#888;border-radius:20px">
                <div class="d-flex align-items-center w-100 h-100 text-center"><i class="fas fa-camera mx-auto fa-5x"></i></div>
            </div>
        </div>
    </div>
    <video class="input_video_vto" style="display: none;" autoplay playsinline></video>
  </div>
...
#sortable-menu-items, #wizard_sortable-menu-items {
    list-style: none;
}
#sortable-menu-items li, #wizard_sortable-menu-items li {
    cursor: grab;
    padding: 0.5em 1em;
    margin: 1em 0;
    border-radius: 1em;
...
.output_canvas, #threejs-container, .output_canvas_vto, #threejs-container-vto{
    position: absolute;
    top: 0;
    left: 0;
    width: 100%;
...
.output_canvas, .output_canvas_vto {
    width: 100%;
    object-fit: none;
    object-position: center;
}

#threejs-container, #threejs-container-vto {
    width: 100%;
    object-fit: cover;
    object-position: center;
}
...
#prev-page, #sg-prev-page {
    left: -20px;
}
#next-page, #sg-next-page {
    right: -20px;
}
